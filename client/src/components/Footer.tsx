        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=100072034105780" target="_blank" rel="noopener noreferrer" className="p-2 bg-white rounded-full hover:opacity-80 transition-opacity">
                <FacebookIcon className="w-5 h-5" />
              </a>
              <a href="https://www.youtube.com/@dawnbuds4727" target="_blank" rel="noopener noreferrer" className="p-2 bg-white rounded-full hover:opacity-80 transition-opacity">
                <YouTubeIcon className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/dawnbudsmodelschool?igsh=YjV1aG8zbWNodHhv" target="_blank" rel="noopener noreferrer" className="p-2 bg-white rounded-full hover:opacity-80 transition-opacity">
